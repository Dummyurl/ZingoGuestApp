...
public class AmenityScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            setContentView(R.layout.activity_amenity_screen);
            ...
            mTotal.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(list != null && list.size() != 0)
                    {
                        ...
                        {
                            AmenityScreen.RoomServicesListAdapter.ViewHolder viewHolder = (AmenityScreen.RoomServicesListAdapter.ViewHolder)
                        ...
                        Intent intent = new Intent(AmenityScreen.this,ServicesListActivity.class);
    ...
    {
        final ProgressDialog dialog = new ProgressDialog(AmenityScreen.this);
                ...
                paidamenitiesresponse.enqueue(new Callback<ArrayList<PaidAmenities>>() {
                    ...
                    public void onResponse(Call<ArrayList<PaidAmenities>> call, Response<ArrayList<PaidAmenities>> response) {
                        ...
                        if(response.code() == 200)
                        {
                            ...
                            {
                                ArrayList<PaidAmenities> paidList = new ArrayList<>();


                                for (int i=0;i<response.body().size();i++)
                                {
                                    if(!response.body().get(i).getCategory().equalsIgnoreCase("Breakfast")&&!response.body().get(i).getCategory().equalsIgnoreCase("Lunch")&&!response.body().get(i).getCategory().equalsIgnoreCase("Dinner"))
                                    {
                                        paidList.add(response.body().get(i));
                                    }
                               ...
                               // list = new ArrayList<>();
                                ...
                                for (int i=0;i<paidList.size();i++)
                                {
                                    ...
                                    if(!categoryNames.contains(paidList.get(i).getCategory()))
                                    {
                                        categoryNames.add(paidList.get(i).getCategory());
                                    }
                                }
                                ...
                                {
                                    ArrayList<PaidAmenities> roomsArrayList = new ArrayList<>();
                                    String name = "";
                                    for (int j=0;j<paidList.size();j++)
                                    {
                                        if(categoryNames.get(i).equalsIgnoreCase(paidList.get(j).getCategory()))
                                        {
                                            roomsArrayList.add(paidList.get(j));
                                            name = categoryNames.get(i);
                                        }

                                    }

                                    list.add(new PaidAmenitiesWithTitle(name,roomsArrayList));
                                }


                                RoomServicesListAdapter roomServicesListAdapter = new RoomServicesListAdapter(
                                        AmenityScreen.this,list);
    ...
    public class RoomServicesListAdapter extends RecyclerView.Adapter<RoomServicesListAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(RoomServicesListAdapter.ViewHolder holder, int position) {
            ...
            if(paidAmenitiesWithTitle != null)
            {
                ...
                {
                    SubServiceAdapter sadapter = new SubServiceAdapter(AmenityScreen.this,paidAmenities);
    ...
    public class SubServiceAdapter  extends RecyclerView.Adapter<SubServiceAdapter.ViewHolder> {
        ...
        public SubServiceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new SubServiceAdapter.ViewHolder(v);
