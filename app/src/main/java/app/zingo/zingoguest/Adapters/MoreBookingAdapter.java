...
public class MoreBookingAdapter  extends RecyclerView.Adapter {
    ...
    public MoreBookingAdapter(Context context)
    {
            ...
            case ITEM:
                ...
                if(bookingAndTraveller != null )
                {
                    ...
                    if(bookings1 != null)
                    {
                        ...
                        viewHolder.mViewDetails.setVisibility(View.GONE);
                        ...
                        viewHolder.mBookingStatus.setText(""+bookings1.getBookingStatus());

                        if(bookings1.getBookingStatus().equalsIgnoreCase("Quick")){
                            viewHolder.mBookingStatus.setBackgroundColor(Color.GREEN);
                        }else if(bookings1.getBookingStatus().equalsIgnoreCase("Active")){
                            viewHolder.mBookingStatus.setBackgroundColor(Color.RED);
                        }else{
                            viewHolder.mBookingStatus.setBackgroundColor(Color.YELLOW);
                        }
                        ...
                        viewHolder.mMainLayout.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                bundle.putSerializable("ActiveBooking",bookings1);
                                Intent bill = new Intent(context, WelcomeScreen.class);
...
//                Do nothing
    ...
    public class BookingViewHolder extends RecyclerView.ViewHolder {
        ...
        public BookingViewHolder(View itemView) {
            ...
            mMainLayout = (LinearLayout) itemView.findViewById(R.id.main_adapter);
